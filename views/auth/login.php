...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/login/'); ?>bengkel.png" />
                            ...
                            <div class="col-lg-6">
                                <div class="p-3">
                                    <div class="text-center">
                                        <img src="<?= base_url('assets/img/login/'); ?>bengkel.png" alt="avatar" width="150">
                                        <h2 class="h5 text-dark mt-4 mb-3 text-monospace">Sistem Pengelolaan Bengkel<br>bengkel</h2>
                                    </div> 
